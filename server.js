...
const images = {
  conversial: "https://cdn.glitch.global/1a419221-c5e6-4ee0-be99-68139bac8dea/craiyon_163915_two_people_having_a_debate_and_arguing_.png?v=1680381622086",
...
var data = JSON.parse(fs.readFileSync(__dirname + '/.data/data.json',{encoding:'utf8', flag:'r'}));
if(!data.servers){
  data.servers = {};
}
